...
from desk.update_runner import load_sources, ordered_sources_for_update, run_update
...
def healthz():
    try:
        ...
        selected_sources = [source.get("name", "") for source in ordered_sources_for_update(load_sources())]
        return (
